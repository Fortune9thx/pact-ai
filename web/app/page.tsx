  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden" style={{ background: "#0a0808" }}>
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen pt-14 px-4 sm:px-6 overflow-hidden">
        ...
        {/* av3 photo — top left */}
        <div className="absolute z-10 av-bob-1" style={{ top: "16%", left: "5%" }}>
        ...
        {/* av4 photo — left mid */}
        <div className="absolute z-10 av-bob-2" style={{ top: "43%", left: "2.5%" }}>
        ...
        <div className="absolute z-10 av-bob-3" style={{ bottom: "24%", left: "7%" }}>
        ...
        {/* av1 photo — top right */}
        <div className="absolute z-10 av-bob-4" style={{ top: "13%", right: "6%" }}>
        ...
        <div className="absolute z-10 av-bob-5" style={{ top: "36%", right: "3%" }}>
        ...
        <div className="absolute z-10 av-bob-6" style={{ bottom: "22%", right: "8%" }}>
        ...
        <div className="absolute z-10 av-bob-7" style={{ bottom: "28%", left: "21%" }}>
