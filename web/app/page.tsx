  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden" style={{ background: "#0a0808" }}>
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen pt-14 px-4 sm:px-6 overflow-hidden">
        ...
        {/* av3 photo — top left */}
        <div className="absolute z-10" style={{ top: "16%", left: "5%", animation: "float 5.2s ease-in-out infinite" }}>
        ...
        {/* av4 photo — left mid */}
        <div className="absolute z-10" style={{ top: "43%", left: "2.5%", animation: "float 6.1s ease-in-out infinite 0.8s" }}>
        ...
        <div className="absolute z-10" style={{ bottom: "24%", left: "7%", animation: "float 4.8s ease-in-out infinite 1.6s" }}>
        ...
        {/* av1 photo — top right */}
        <div className="absolute z-10" style={{ top: "13%", right: "6%", animation: "float 5.7s ease-in-out infinite 0.4s" }}>
        ...
        <div className="absolute z-10" style={{ top: "36%", right: "3%", animation: "float 6.5s ease-in-out infinite 1.2s" }}>
        ...
        <div className="absolute z-10" style={{ bottom: "22%", right: "8%", animation: "float 5.0s ease-in-out infinite 2.0s" }}>
        ...
        <div className="absolute z-10" style={{ bottom: "28%", left: "21%", animation: "float 4.6s ease-in-out infinite 0.2s" }}>
